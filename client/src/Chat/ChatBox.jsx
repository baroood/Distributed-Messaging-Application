...
const ChatBox = (props) => {
  ...
  const deleteConversationMessages = usedeleteConversationMessages();
  const editConversationMessages = useeditConversationMessages();
                  ...
                  >
                    ...
                    <ListItemText
                     ...
                     <ListItemSecondaryAction>
                        <IconButton edge="end" aria-label="delete" onClick={() => { const msg = prompt("Edit message", m.body); editConversationMessages(m._id, msg); reloadMessages();}}>
                        <EditIcon />
                        </IconButton>
                        <IconButton edge="end" aria-label="delete" onClick={() => { deleteConversationMessages(m._id); reloadMessages(); }}>
                        <DeleteIcon />
                        </IconButton>
                    </ListItemSecondaryAction>
                    }
